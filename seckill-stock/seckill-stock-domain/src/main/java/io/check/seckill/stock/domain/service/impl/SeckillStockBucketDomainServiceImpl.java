package io.check.seckill.stock.domain.service.impl;
...
public class SeckillStockBucketDomainServiceImpl implements SeckillStockBucketDomainService {
    ...
    public boolean suspendBuckets(Long goodsId) {
        ...
        SeckillStockBucketEvent seckillStockBucketEvent = new
                SeckillStockBucketEvent(goodsId, SeckillStockBucketEventType.DISABLED.getCode(), getTopicEvent());
    ...
    public boolean resumeBuckets(Long goodsId) {
        ...
        SeckillStockBucketEvent seckillStockBucketEvent = new
                SeckillStockBucketEvent(goodsId, SeckillStockBucketEventType.ENABLED.getCode(), getTopicEvent());
        messageSenderService.send(seckillStockBucketEvent);
    ...
    public boolean arrangeBuckets(Long goodsId, List<SeckillStockBucket> buckets) {
        ...
        SeckillStockBucketEvent seckillStockBucketEvent = new
                SeckillStockBucketEvent(goodsId, SeckillStockBucketEventType.ARRANGED.getCode(), getTopicEvent());
        messageSenderService.send(seckillStockBucketEvent);
    ...
    private String getTopicEvent(){
        return SeckillConstants.EVENT_PUBLISH_TYPE_ROCKETMQ.equals(eventType) ?
                SeckillConstants.TOPIC_EVENT_ROCKETMQ_STOCK : SeckillConstants.TOPIC_EVENT_COLA;
    }
