...
public class SeckillPlaceOrderBucketService implements SeckillPlaceOrderService {
    ...
    public Long placeOrder(Long userId, SeckillOrderCommand seckillOrderCommand) {
        ...
        messageSenderService.sendMessageInTransaction(
                this.getTxMessage(SeckillConstants.TOPIC_BUCKET_TX_MSG, txNo, userId,
                        SeckillConstants.PLACE_ORDER_TYPE_BUCKET, exception, seckillOrderCommand, seckillGoods,
                        bucketSerialNo, seckillOrderCommand.getOrderTaskId()),
                null);
        return txNo;
    }
    ...
    private String getStockBucketKey(Long goodsId, Integer serialNo){
        return SeckillConstants.getKey(SeckillConstants.getKey(SeckillConstants.GOODS_BUCKET_AVAILABLE_STOCKS_KEY,
                String.valueOf(goodsId)),String.valueOf(serialNo));
    }
    ...
    public void saveOrderInTransaction(TxMessage txMessage) {
        try {
            ...
            distributedCacheService.put(SeckillConstants
                    .getKey(SeckillConstants.ORDER_TX_KEY, String.valueOf(txMessage.getTxNo())),
